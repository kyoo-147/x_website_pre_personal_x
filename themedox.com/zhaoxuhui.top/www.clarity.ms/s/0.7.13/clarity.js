/* clarity-js v0.7.13: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get queue() {
    ...
    function Y(t, e, n) {
        return window.setTimeout($r(t), e, n)
    }
    ...
    function F() {
        ...
        L = {
            gap: t - P
        }, gr(25), L.gap < 3e5 ? B = Y(F, U) : di && (A("clarity", "suspend"), Ii(), ["mousemove", "touchstart"].forEach((function(t) {
            return ei(document, t, gi)
        })), ["resize", "scroll", "pageshow"].forEach((function(t) {
            return ei(window, t, gi)
        })))
    }
    var J = Object.freeze({
            __proto__: null,
    ...
    function Ut() {
        Nt = 1, _t = [], It = [], Ct = {}, Dt = [], jt = [], At = "address,password,contact".split(","), Lt = "password,secret,pass,social,ssn,code,hidden".split(","), zt = "radio,checkbox,range,button,reset,submit".split(","), Rt = "INPUT,SELECT,TEXTAREA".split(","), Tt = new Map, Ht = new WeakMap, qt = new WeakMap, Wt = new WeakMap, Yt = new WeakMap, St = {}
    }
    ...
    var oe = Object.freeze({
            ...
            add: function(t, e, n, a) {
                var r, i = Vt(t, !0),
                    ...
                    f = o.content ? 1 : 3;
                u >= 0 && _t[u] && ((s = _t[u]).children.push(i), l = null === l ? s.region : l, d = null === d ? s.metadata.fraud : d, f = s.metadata.privacy), n.attributes && "data-clarity-region" in n.attributes && (Fe(t, n.attributes["data-clarity-region"]), l = i), Tt.set(i, t), _t[i] = {
                        id: i,
                        parent: u,
                        previous: c,
                        children: [],
                    ...
                    }(t, _t[i], s), Kt(_t[i]), "IMG" === (r = _t[i]).data.tag && 3 === r.metadata.privacy && (r.metadata.size = []), ie(i, a)
            },
            get: $t,
            getId: Vt,
            getNode: Qt,
    ...
    function ve() {
        ...
        t && (le = t, t.task().then((function() {
            t.id === Lr() && (t.resolve(), le = null, ve())
        })).catch((function(e) {
            t.id === Lr() && (e && Qa(0, 1, e.name, e.message, e.stack), le = null, ve())
        })))
    }
    ...
    function be(t) {
        var e = performance.now(),
            n = we(t),
            a = e - ce[n].start;
        q(t.cost, a), H(5), ce[n].calls > 0 && q(4, a)
    }
    ...
    function ze(t, e) {
        null === t && (t = Animation.prototype[e], Animation.prototype[e] = function() {
            if (pi()) {
                if (!this[Ce]) {
                    this[Ce] = Yr(), this[De] = 0;
                    var n = this.effect.getKeyframes(),
                        a = this.effect.getTiming();
                    Le(s(), this[Ce], 0, JSON.stringify(n), JSON.stringify(a), Vt(this.effect.target))
                }
                if (this[De]++ < je) {
                    var r = null;
                    switch (e) {
    ...
    function Re(t, e, n) {
        return void 0 === e && (e = null), void 0 === n && (n = null), at(this, void 0, void 0, (function() {
            var a, r, i, u, c, l, d, f, h, p, v, g, b, y, w, k, E, O, S, x, M, N, I, C, D;
            return rt(this, (function(j) {
                switch (j.label) {
                    case 0:
                        ...
                        return [3, 11];
                    case 1:
                        return i = Ee, r.push(i.width), r.push(i.height), T(t, i.width, i.height), Wa(r), [3, 11];
                    case 2:
                        for (u = 0, c = Ye; u < c.length; u++) l = c[u], (r = [l.time, 7]).push(l.data.id), r.push(l.data.interaction), r.push(l.data.visibility), r.push(l.data.name), Wa(r);
                        return $e(), [3, 11];
                    case 3:
                        for (d = 0, f = Me; d < f.length; d++) h = f[d], (r = [h.time, h.event]).push(h.data.id), r.push(h.data.operation), r.push(h.data.keyFrames), r.push(h.data.timing), r.push(h.data.timeline), r.push(h.data.targetId), Wa(r);
                        return Ae(), [3, 11];
                    case 4:
                    ...
                    case 7:
                        ...
                        for (w = b.data, k = b.metadata.active, E = b.metadata.suspend, O = b.metadata.privacy, S = function(t) {
                            ...
                            }(b), x = 0, M = k ? ["tag", "attributes", "value"] : ["tag"]; x < M.length; x++)
                            if (w[N = M[x]]) switch (N) {
                                case "tag":
                                    I = He(b), C = S ? -1 : 1, r.push(b.id * C), b.parent && k && r.push(b.parent), b.previous && k && r.push(b.previous), r.push(E ? "*M" : w[N]), I && 2 === I.length && r.push("".concat("#").concat(qe(I[0]), ".").concat(qe(I[1])));
                                    break;
                                case "attributes":
                                    for (D in w[N]) void 0 !== w[N][D] && r.push(We(D, w[N][D], O));
                                    break;
                                case "value":
                                    Et(b.metadata.fraud, b.id, w[N]), r.push(m(w[N], w.tag, O, S))
                            }
                        j.label = 8;
                    case 8:
                        return v++, [3, 5];
    ...
    function Fe(t, e) {
        !1 === Xe.has(t) && (Xe.set(t, e), (Ve = null === Ve && Be ? new IntersectionObserver(Ke, {
    ...
    function Ge() {
        for (var t = [], e = 0, n = Ue; e < n.length; e++) {
            var a = n[e],
                r = Vt(a.node);
            r in Pe || (r ? (a.data.id = r, Pe[r] = a.data, Ye.push(Qe(a.data))) : t.push(a))
        }
        Ue = t, Ye.length > 0 && Re(7)
    }
    ...
    function Ze(t, e, n, a) {
        ...
        e.interaction = n > e.interaction ? n : e.interaction, e.visibility = a > e.visibility ? a : e.visibility, e.id ? (e.id in Pe && r || !(e.id in Pe)) && (Pe[e.id] = e, Ye.push(Qe(e))) : Ue.push({
            node: t,
            data: e
        })
    }
    ...
    function Mn(t) {
        switch (t.event) {
            ...
            case 19:
                ...
                }(n, t) && En.pop(), En.push(t), X(On), On = Y(Nn, 500, t.event);
                break;
            default:
                En.push(t), Nn(t.event)
        }
    }
    ...
    function jn(t) {
        ...
        if ((null !== t || 0 !== i || 0 !== o) && null !== i && null !== o) {
            ...
            }(l, u) && Cn.pop(), Cn.push(u), X(Dn), Dn = Y(An, 500, 10)
        }
    }
    ...
    function Hn(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            ...
            null !== zn && null !== Ln.start && n !== e.anchorNode && (X(Rn), qn(21)), Ln = {
                start: e.anchorNode,
                startOffset: e.anchorOffset,
                end: e.focusNode,
                endOffset: e.focusOffset
            }, zn = e, X(Rn), Rn = Y(qn, 500, 21)
        }
    }
    ...
    function Kn(t) {
        ! function(t) {
            var e = Jt(t);
            ei(e ? e.contentWindow : t === document ? window : t, "scroll", jn, !0)
        }(t), t.nodeType === Node.DOCUMENT_NODE && (un(t), function(t) {
            ei(t, "cut", pn.bind(this, 0), !0), ei(t, "copy", pn.bind(this, 1), !0), ei(t, "paste", pn.bind(this, 2), !0)
        }(t), function(t) {
            ei(t, "mousedown", Sn.bind(this, 13, t), !0), ei(t, "mouseup", Sn.bind(this, 14, t), !0), ei(t, "mousemove", Sn.bind(this, 12, t), !0), ei(t, "wheel", Sn.bind(this, 15, t), !0), ei(t, "dblclick", Sn.bind(this, 16, t), !0), ei(t, "touchstart", xn.bind(this, 17, t), !0), ei(t, "touchend", xn.bind(this, 18, t), !0), ei(t, "touchmove", xn.bind(this, 19, t), !0), ei(t, "touchcancel", xn.bind(this, 20, t), !0)
        }(t), function(t) {
            ei(t, "input", bn, !0)
        }(t), function(t) {
            ei(t, "selectstart", Hn.bind(this, t), !0), ei(t, "selectionchange", Hn.bind(this, t), !0)
        }(t), function(t) {
            ei(t, "change", en, !0)
        }(t), function(t) {
            ei(t, "submit", Un, !0)
    ...
    var Zn = Object.freeze({
            ...
            observe: Kn,
            start: function() {
                Ma = [], Ta(), fn(), vn(), Tn(), wn(), ei(window, "resize", _n), _n(), ei(document, "visibilitychange", Jn), Jn(), Cn = [], jn(), Wn(), nn(), Bn(), ei(window, "pagehide", Vn)
            },
            stop: function() {
                Ma = [], Ta(), fn(), vn(), X(On), En.length > 0 && Nn(En[En.length - 1].event), X(gn), wn(), In(), Gn(), X(Dn), Cn = [], Wn(), X(Rn), nn(), Bn(), Fn()
            }
        }),
        Qn = /[^0-9\.]/g;
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                ...
                case "aggregaterating":
                    t.ratingValue && (W(11, ta(t.ratingValue, 100)), W(18, ta(t.bestRating)), W(19, ta(t.worstRating))), W(12, ta(t.ratingCount)), W(17, ta(t.reviewCount));
                    break;
                case "person":
                    Mr(8, t.name);
                    break;
                case "offer":
                    Mr(7, t.availability), Mr(14, t.itemCondition), Mr(13, t.priceCurrency), Mr(12, t.sku), W(13, ta(t.price));
                    break;
                case "brand":
                    Mr(6, t.name)
            }
            ...
            case Node.ELEMENT_NODE:
                ...
                switch (i = t.parentElement ? t.parentElement : t.parentNode ? t.parentNode : null, "http://www.w3.org/2000/svg" === v.namespaceURI && (g = "svg:" + g), g) {
                    ...
                    case "IFRAME":
                        ...
                        Ft(M) && (! function(t) {
                            !1 === ee(t) && ei(t, "load", Ea.bind(this, t, "childList"), !0)
                        }(M), N.attributes["*O"] = "true", M.contentDocument && M.contentWindow && "loading" !== M.contentDocument.readyState && (a = M.contentDocument)), oe[r](t, i, N, e);
                        break;
                    default:
                        var T = {
                            tag: g,
                        ...
                        v.shadowRoot && (a = v.shadowRoot), oe[r](t, i, T, e)
                }
        }
        return a
    }
        ...
        ee(t) || (! function(t) {
            try {
                var e = u("MutationObserver"),
                    n = e in window ? new window[e]($r(ma)) : null;
                n && (n.observe(t, {
                    attributes: !0,
                    childList: !0,
                    characterData: !0,
    ...
    function ka(t) {
        return ha.indexOf(t) < 0 && ha.push(t), pa && X(pa), pa = Y((function() {
            ! function() {
    ...
    function xa(t, e) {
        return void 0 === e && (e = null), at(this, void 0, void 0, (function() {
            var n, a, r, i, o, u, c, l, d, f, h, p, v, g, y, w, k, E, O, S, x, M, N, _, C, D, j, A, L, z, R;
            return rt(this, (function(H) {
                switch (n = e || s(), a = [n, t], t) {
                    ...
                    case 19:
                    case 20:
                        for (r = 0, i = En; r < i.length; r++) z = i[r], (o = Sa(z.data.target, z.event)).id > 0 && ((a = [z.time, z.event]).push(o.id), a.push(z.data.x), a.push(z.data.y), Wa(a), T(z.event, z.data.x, z.data.y));
                        Tn();
                        break;
                    case 9:
                        for (u = 0, c = on; u < c.length; u++) z = c[u], l = Sa(z.data.target, z.event, z.data.text), a = [z.time, z.event], d = l.hash ? l.hash.join(".") : "", a.push(l.id), a.push(z.data.x), a.push(z.data.y), a.push(z.data.eX), a.push(z.data.eY), a.push(z.data.button), a.push(z.data.reaction), a.push(z.data.context), a.push(m(z.data.text, "click", l.privacy)), a.push(b(z.data.link)), a.push(d), a.push(z.data.trust), Wa(a), _a(z.time, z.event, d, z.data.x, z.data.y, z.data.reaction, z.data.context);
                        fn();
                        break;
                    case 38:
                        for (f = 0, h = hn; f < h.length; f++) z = h[f], a = [z.time, z.event], (j = Sa(z.data.target, z.event)).id > 0 && (a.push(j.id), a.push(z.data.action), Wa(a));
                        vn();
                        break;
                    case 11:
                        p = kn, a.push(p.width), a.push(p.height), T(t, p.width, p.height), In(), Wa(a);
                        break;
                    case 26:
                        v = Yn, a.push(v.name), Fn(), Wa(a);
                        break;
                    case 27:
                        for (g = 0, y = mn; g < y.length; g++) z = y[g], w = Sa(z.data.target, z.event, z.data.value), (a = [z.time, z.event]).push(w.id), a.push(m(z.data.value, "input", w.privacy)), Wa(a);
                        wn();
                        break;
                    case 21:
                        (k = Ln) && (E = Sa(k.start, t), O = Sa(k.end, t), a.push(E.id), a.push(k.startOffset), a.push(O.id), a.push(k.endOffset), Wn(), Wa(a));
                        break;
                    case 10:
                        for (S = 0, x = Cn; S < x.length; S++) z = x[S], (M = Sa(z.data.target, z.event)).id > 0 && ((a = [z.time, z.event]).push(M.id), a.push(z.data.x), a.push(z.data.y), Wa(a), T(z.event, z.data.x, z.data.y));
                        Cn = [];
                        break;
                    case 42:
                        for (N = 0, _ = tn; N < _.length; N++) z = _[N], a = [z.time, z.event], (j = Sa(z.data.target, z.event)).id > 0 && ((a = [z.time, z.event]).push(j.id), a.push(z.data.type), a.push(m(z.data.value, "change", j.privacy)), a.push(m(z.data.checksum, "checksum", j.privacy)), Wa(a));
                        nn();
                        break;
                    case 39:
                        for (C = 0, D = Pn; C < D.length; C++) z = D[C], a = [z.time, z.event], (j = Sa(z.data.target, z.event)).id > 0 && (a.push(j.id), Wa(a));
                        Bn();
                        break;
                    case 22:
                        for (A = 0, L = Na; A < L.length; A++) z = L[A], (a = [z.time, z.event]).push(z.data.type), a.push(z.data.hash), a.push(z.data.x), a.push(z.data.y), a.push(z.data.reaction), a.push(z.data.context), Wa(a, !1);
                        Ta();
                        break;
                    case 28:
                        R = Xn, a.push(R.visible), Wa(a), I(n, R.visible), Gn()
                }
                return [2]
            }))
        }))
    ...
    function qa() {
        ja = !0, La = 0, za = 0, Ha = 0, Ia = [], Ca = [], Da = {}, Aa = null
    }
    ...
    function Wa(t, e) {
        if (void 0 === e && (e = !0), ja) {
            ...
            H(25);
            var i = function() {
                var t = !1 === o.lean && La > 0 ? 100 : Fr.sequence * o.delay;
                return "string" == typeof o.upload ? Math.max(Math.min(t, 3e4), 100) : o.delay
            }();
            n - Ha > 2 * i && (X(Ra), Ra = null), e && null === Ra && (25 !== a && V(), Ra = Y(Xa, i), Ha = n, br(za))
        }
    }

    function Ya() {
        X(Ra), Xa(!0), La = 0, za = 0, Ha = 0, Ia = [], Ca = [], Da = {}, Aa = null, ja = !1
    }
    ...
    function Xa(t) {
        return void 0 === t && (t = !1), at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return Ra = null, (e = !1 === o.lean && za > 0 && (za < 1048576 || Fr.sequence > 0)) && W(1, 1), Ge(),
                            function() {
                                var t = [];
                                Na = [];
                                for (var e = Fr.start + Fr.duration, n = Math.max(e - 2e3, 0), a = 0, r = Ma; a < r.length; a++) {
                                    var i = r[a];
                                    i.time >= n && (i.time <= e && Na.push(i), t.push(i))
                                }
                                Ma = t, xa(22)
                            }(), yt(), n = !0 === t, a = JSON.stringify(Kr(n)), r = "[".concat(Ca.join(), "]"), i = e ? "[".concat(Ia.join(), "]") : "", u = function(t) {
                    ...
                    case 2:
                        s = l.sent(), l.label = 3;
                    case 3:
                        return q(2, (c = s) ? c.length : u.length), Pa(u, c, Fr.sequence, n), Ca = [], e && (Ia = [], za = 0, La = 0), [2]
                }
            }))
        }))
    }
        ...
        if (void 0 === a && (a = !1), "string" == typeof o.upload) {
            ...
            if (!1 === i) {
                ...
                u.open("POST", r, !0), u.timeout = 15e3, u.ontimeout = function() {
                    Qr(new Error("".concat("Timeout", " : ").concat(r)))
    ...
    function Ga(t) {
        return at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(n) {
                switch (e = [s(), t], t) {
                    case 31:
                        e.push(Va.message), e.push(Va.line), e.push(Va.column), e.push(Va.stack), e.push(b(Va.source)), Wa(e);
                        break;
                    case 33:
                        Ka && (e.push(Ka.code), e.push(Ka.name), e.push(Ka.message), e.push(Ka.stack), e.push(Ka.severity), Wa(e, !1));
                        break;
                    case 41:
    ...
    function Qa(t, e, n, a, r) {
        ...
        t in Za && Za[t].indexOf(i) >= 0 || (Ka = {
            code: t,
            name: n,
            message: a,
            stack: r,
            severity: e
        }, t in Za ? Za[t].push(i) : Za[t] = [i], Ga(33))
    }
    var $a, tr = {},
        er = new Set,
        nr = {},
    ...
    function gr(t) {
        ...
        switch (t) {
            case 4:
                var n = S;
                n && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), Wa(e, !1)), N();
                break;
            case 25:
                e.push(L.gap), Wa(e);
                break;
            case 35:
                e.push($a.check), Wa(e, !1);
                break;
            case 3:
                e.push(tt.key), Wa(e);
                break;
            case 2:
                e.push(Aa.sequence), e.push(Aa.attempts), e.push(Aa.status), Wa(e, !1);
                break;
            case 24:
    ...
    function br(t) {
        if (0 === $a.check) {
            var e = $a.check;
            e = Fr.sequence >= 128 ? 1 : e, e = Fr.pageNum >= 128 ? 7 : e, e = s() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== $a.check && yr(e)
        }
    }
    ...
    function Dr() {
        ...
        _r = {
            ...
            sessionId: r.session,
            pageNum: r.count
        }, o.lean = o.track && null !== r.upgrade ? 0 === r.upgrade : o.lean, o.upload = o.track && "string" == typeof o.upload && r.upload && r.upload.length > "https://".length ? r.upload : o.upload, Mr(0, e), Mr(3, n), Mr(1, b(location.href, !!a)), Mr(2, document.referrer), Mr(15, function() {
            var t = Yr();
            ...
            return t
        }()), Mr(16, document.documentElement.lang), Mr(17, document.dir), Mr(26, "".concat(window.devicePixelRatio)), Mr(28, i.dob.toString()), Mr(29, i.version.toString()), W(0, r.ts), W(1, 0), W(35, a), navigator && (Mr(9, navigator.language), W(33, navigator.hardwareConcurrency), W(32, navigator.maxTouchPoints), W(34, Math.round(navigator.deviceMemory)), (t = navigator.userAgentData) && t.getHighEntropyValues ? t.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
            Mr(22, t.platform), Mr(23, t.platformVersion), null === (e = t.brands) || void 0 === e || e.forEach((function(t) {
                Mr(24, t.name + "~" + t.version)
            })), Mr(25, t.model), W(27, t.mobile ? 1 : 0)
        })) : Mr(22, navigator.platform)), screen && (W(14, Math.round(screen.width)), W(15, Math.round(screen.height)), W(16, Math.round(screen.colorDepth)));
    ...
    function Hr() {
        ...
        }(n), Br("_clsk", [_r.sessionId, t, _r.pageNum, n, e].join("|"), 1)
    }
    ...
    function Wr(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e || t.dob !== a) && Br("_clck", [_r.userId, 2, n.toString(36), e, a].join("|"), 365)
    }
    ...
    function Pr() {
        ...
        if (e && e.length > 0) {
            ...
            n.length > 1 && (t.version = Xr(n[1])), n.length > 2 && (t.expiry = Xr(n[2], 36)), n.length > 3 && 1 === Xr(n[3]) && (t.consent = 1), n.length > 4 && Xr(n[1]) > 1 && (t.dob = Xr(n[4])), o.track = o.track || 1 === t.consent, t.id = o.track ? n[0] : t.id
        }
        return t
    }
            ...
            try {
                if (null === Cr) {
                    for (var u = location.hostname ? location.hostname.split(".") : [], c = u.length - 1; c >= 0; c--)
                        if (Cr = ".".concat(u[c]).concat(Cr || ""), c < u.length - 1 && (document.cookie = "".concat(i).concat(";").concat("domain=").concat(Cr), Ur(t) === e)) return;
                    Cr = ""
                }
            } catch (t) {
                Cr = ""
    ...
    function Kr(t) {
        return Fr.start = Fr.start + Fr.duration, Fr.duration = s() - Fr.start, Fr.sequence++, Fr.upload = t && "sendBeacon" in navigator ? 1 : 0, Fr.end = t ? 1 : 0, [Fr.version, Fr.sequence, Fr.start, Fr.duration, Fr.projectId, Fr.userId, Fr.sessionId, Fr.pageNum, Fr.upload, Fr.end]
    }
    ...
    function Qr(t) {
        if (Vr && -1 === Vr.indexOf(t.message)) {
            ...
            if (e && e.length > 0) {
                ...
                a.open("POST", e, !0), a.send(JSON.stringify(n)), Vr.push(t.message)
            }
        }
        return t
    }
    ...
    function ei(t, e, n, a) {
        void 0 === a && (a = !1), n = $r(n);
        try {
            t[u("addEventListener")](e, n, a), ti.push({
                event: e,
                target: t,
                listener: n,
                capture: a
    ...
    function ui() {
        return !(oi++ > 20) || (Qa(4, 0), !1)
    }

    function ci() {
        oi = 0, ii !== li() && (Ii(), window.setTimeout(si, 250))
    }
    ...
    function fi() {
        di = !0, c = performance.now(), he(), ni(), Zr(), ii = li(), oi = 0, ei(window, "popstate", ci), null === ai && (ai = history.pushState, history.pushState = function() {
            ai.apply(this, arguments), pi() && ui() && ci()
        }), null === ri && (ri = history.replaceState, history.replaceState = function() {
            ri.apply(this, arguments), pi() && ui() && ci()
        })
    }

    function hi() {
        ii = null, oi = 0, Zr(), ni(), he(), c = 0, di = !1
    }
    ...
    function vi(t) {
        if (null === t || di) return !1;
        for (var e in t) e in o && (o[e] = t[e]);
        return !0
    }

    function gi() {
        _i(), A("clarity", "restart")
    }
            ...
            Se(), xe(), $e(), Ve = null, Xe = new WeakMap, Pe = {}, Ue = [], Be = !!window.IntersectionObserver, Xt(),
                function() {
                    if (ca = [], ha = [], pa = null, va = 0, ga = {}, null === la && (la = CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.insertRule = function() {
                            return pi() && ka(this.ownerNode), la.apply(this, arguments)
                        }), null === da && (da = CSSStyleSheet.prototype.deleteRule, CSSStyleSheet.prototype.deleteRule = function() {
                            return pi() && ka(this.ownerNode), da.apply(this, arguments)
                        }), null === fa) {
                        fa = Element.prototype.attachShadow;
                        try {
                            Element.prototype.attachShadow = function() {
                                return pi() ? ka(fa.apply(this, arguments)) : fa.apply(this, arguments)
                            }
                        } catch (t) {
                            fa = null
                        }
                    }
                }(), pe(bi, 1).then((function() {
                    $r(xe)(), $r(Ge)()
                })), window.Animation && window.KeyframeEffect && window.KeyframeEffect.prototype.getKeyframes && window.KeyframeEffect.prototype.getTiming && (Ae(), ze(Ne, "play"), ze(Te, "pause"), ze(_e, "cancel"), ze(Ie, "finish"))
        },
        stop: function() {
        ...
        ki = {
            ...
            function(t) {
                at(this, void 0, void 0, (function() {
                    var e, n;
                    return rt(this, (function(a) {
                        return e = s(), n = [e, t], 29 === t && (n.push(ki.fetchStart), n.push(ki.connectStart), n.push(ki.connectEnd), n.push(ki.requestStart), n.push(ki.responseStart), n.push(ki.responseEnd), n.push(ki.domInteractive), n.push(ki.domComplete), n.push(ki.loadEventStart), n.push(ki.loadEventEnd), n.push(ki.redirectCount), n.push(ki.size), n.push(ki.type), n.push(ki.protocol), n.push(ki.encodedSize), n.push(ki.decodedSize), Ei(), Wa(n)), [2]
                    }))
                }))
            }(29)
    }
    ...
    function xi() {
        try {
            wi && wi.disconnect(), wi = new PerformanceObserver($r(Mi));
            for (var t = 0, e = Si; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && q(9, 0), wi.observe({
                    type: n,
                    buffered: !0
                }))
            }
        ...
        ! function(t) {
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "resource":
                        var r = a.name;
                        Mr(4, Ni(r)), r !== o.upload && r !== o.fallback || W(28, a.duration);
                        break;
                    case "longtask":
                        H(7);
                        break;
    ...
    var Ti = [mi, yi, Zn, Object.freeze({
        __proto__: null,
        start: function() {
            Ei(),
                function() {
                    navigator && "connection" in navigator && Mr(27, navigator.connection.effectiveType), window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? ei(window, "load", Y.bind(this, xi, 0)) : xi() : Qa(3, 0)
                }()
        },
        stop: function() {
            wi && wi.disconnect(), wi = null, Ei()
        }
    })];
    ...
    function _i(t) {
        void 0 === t && (t = null),
            function() {
                try {
                    return !1 === di && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now" in Date && "now" in performance && "undefined" != typeof WeakMap
                } catch (t) {
                    return !1
                }
            }() && (vi(t), fi(), mt(), Ti.forEach((function(t) {
                return $r(t.start)()
            })), null === t && Ai())
    }

    function Ii() {
        pi() && (Ti.slice().reverse().forEach((function(t) {
            return $r(t.stop)()
        })), bt(), hi(), void 0 !== Di && (Di[ji] = function() {
            (Di[ji].q = Di[ji].q || []).push(arguments), "start" === arguments[0] && Di[ji].q.unshift(Di[ji].q.pop()) && Ai()
        }))
    }
    var Ci = Object.freeze({
            ...
            metadata: Ar,
            pause: function() {
                pi() && (A("clarity", "pause"), null === de && (de = new Promise((function(t) {
                    fe = t
                }))))
            },
            resume: function() {
                pi() && (de && (fe(), de = null, null === le && ve()), A("clarity", "resume"))
            },
            set: ot,
            start: _i,
            stop: Ii,
    ...
    function Ai() {
        if (void 0 !== Di) {
            if (Di[ji] && Di[ji].v) return console.warn("Error CL001: Multiple Clarity tags detected.");
            var t = Di[ji] && Di[ji].q || [];
            for (Di[ji] = function(t) {
                    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                    return Ci[t].apply(Ci, e)
                }, Di[ji].v = l; t.length > 0;) Di[ji].apply(Di, t.shift())
        }
    }
    Ai()
}();