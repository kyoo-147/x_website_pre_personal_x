/*! highlight.js v9.3.0 | BSD3 License | git.io/hljslicense */ ! function(e) {
    ...
    function i(e) {
        ...
        if (i += e.parentNode ? e.parentNode.className : "", r = /\blang(?:uage)?-([\w-]+)\b/i.exec(i)) {
    ...
    function u(e, r, n, i) {
        ...
        function _(e, t) {
            ...
            var r = s(t, x);
            if (r) {
                return r.skip ? E += t : (r.eB && (E += t), g(), r.rB || r.eB || (E = t)), h(r, t), r.rB ? 0 : t.length
            }
            var a = c(x, t);
            if (a) {
                var n = x;
        ...
        try {
            for (var $, z, L = 0;;) {
                if (x.t.lastIndex = L, $ = x.t.exec(r), !$) {
                    break
                }
                z = _(r.substr(L, $.index - L), $[0]), L = $.index + z
            }
            for (_(r.substr(L)), N = x; N.parent; N = N.parent) {
                N.cN && (M += "</span>")
            }
            return {
                r: B,
